...
public class TestSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //TODO 替换merchant_id
        map.put("merchant_id", "5820118");
        //TODO 替换business_id
        map.put("business_id", "6097401");
        map.put("activity_id", "7096513");
        ...
        map.put("item_code", "redvip1_23H1");
        //实际生产环境根据充值情况传数量
        ...
        String url = "http://qa.igame.163.com/api/music-vip-open/partner/vip-sub/v2";
